...
import sys
sys.path.append(
    str(Path().absolute().parent))  # this command beginning in the folder of file test_prediction.py everywhere you launch it, this path is in the folder section-production-model-package
