...
import sys
sys.path.append(str(Path().absolute()))  # this command beginning in the folder of file setup.py everywhere you launch it, this path is in the folder section-production-model-package
