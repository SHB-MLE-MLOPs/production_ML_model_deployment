...
def validate_inputs(*, input_data: pd.DataFrame) -> Tuple[pd.DataFrame, Optional[dict]]:
    ...
    # One of goal of block try-except is to ensure that the input data for prediction has a correct type,
    # so we check this according to class "TitanicDataInputSchema" when we define the type of all feature in the input data
