...
# PACKAGE_ROOT = Path().absolute() # path associated to the folder where tox file is located (this method don't need to import folder "classification_model")
PACKAGE_ROOT = Path(classification_model.__file__).resolve().parent.parent # path associated to the folder where tox file is located (this method need to import folder "classification_model")
